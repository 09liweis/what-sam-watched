...
<template>
  ...
  <template v-else>
    ...
    <section class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
      <div
        class="flex flex-col items-center justify-center p-4 bg-white rounded-lg shadow hover:shadow-md transition"
      >
        <span class="text-sm text-gray-500">Total</span>
        <span class="mt-1 text-2xl font-bold text-indigo-600">{{
          props.stats.total
        }}</span>
      </div>
      <div
      ...
      <section class="bg-white p-4 rounded-lg shadow">
        ...
        <div class="flex flex-wrap gap-2">
          ...
          <NuxtLink
            ...
            :to="{
              query: { lang: props.curLang, country, genre: props.curGenre },
            }"
            class="px-2 py-1 text-sm"
          >
            {{ country }}
      ...
      <section class="bg-white p-4 rounded-lg shadow">
        ...
        <div class="flex flex-wrap gap-2">
          ...
          <NuxtLink
            ...
            :to="{
              query: { lang, genre: props.curGenre, country: props.curCountry },
            }"
            class="px-2 py-1 text-sm"
          >
            {{ lang }}
      ...
      <section class="bg-white p-4 rounded-lg shadow">
        ...
        <div class="flex flex-wrap gap-2">
          ...
          <NuxtLink
            ...
            :to="{
              query: { genre, lang: props.curLang, country: props.curCountry },
            }"
            class="px-2 py-1 text-sm"
          >
            {{ genre }}
